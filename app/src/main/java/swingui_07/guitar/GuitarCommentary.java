...
public class GuitarCommentary
{
    ...
    public void test()
    {
        ...
        (
            ...
            //(
                ...
                .onCheckChanged((guitar) -> { System.out.printf("selected: %s%n", guitar); fgUpdater.update(); })
    ...
    class CommentColorUpdater
    {
        ...
        private UIValue<Color> air = UIValue.of(UNSELECTED);
        ...
        public void update()
        {
            ...
            air.set(Guitar.AIR.equals(selected.get()) ? SELECTED : UNSELECTED);
        }
    }
}
